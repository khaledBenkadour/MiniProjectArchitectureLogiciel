package com.photo.app.api.zuul.api.gateway.security;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(environment.getProperty("api.users.enseignant.url.path")).permitAll()
                .antMatchers(environment.getProperty("api.users.module.url.path")).permitAll()
